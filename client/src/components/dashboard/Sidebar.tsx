...
// Removed unused icons: LayoutDashboard, User, Wallet, BarChart3
import { Settings, FolderKanban, PlusSquare, LogOut } from 'lucide-react'; // Added LogOut
...
Button.defaultProps = { variant: "ghost", size: "default" }; // Removed @ts-ignore
